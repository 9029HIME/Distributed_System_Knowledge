...
## 71-RedisTemplate连接Redis分片集群

1. 和哨兵模式类似，修改配置文件，这里要指定集群的所有Redis节点：
   ...
   spring:
   	redis:
   		cluster:
   			nodes:
   				-192.168.120.161:6379
   				-192.168.120.161:7001
   				-192.168.120.121:6379
   				-192.168.120.121:7001
   				-192.168.120.122:6379
   				-192.168.120.122:7001
   ```

2. 配置读写分离策略，和连接哨兵集群一样：
